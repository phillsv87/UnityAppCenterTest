...
namespace UnitySpotify
{
    ...
    /// <summary>
    /// Implements the IUnitySpotifyApi interface using the Spotify Web API.
    /// </summary>
    public class WebUnitySpotifyApi : IUnitySpotifyApi, IDisposable
    {
        ...
        public WebUnitySpotifyApi(ClientConfig config)
        {
        ...
        private async Task RepeatAsync(RepeatMode mode, CancellationToken cancel)
        {
            await SendAsync(
                "Repeat",
                HttpMethod.Put,
